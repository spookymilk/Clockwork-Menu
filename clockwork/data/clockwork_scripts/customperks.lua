...
addPerk(perk_list,"POOP_PERK","Poop","Maybe a glass of prune juice wasn't the best idea.","data/clockwork_gfx/perks/poop.png","data/clockwork_gfx/perks/poopy.png",2,nil,
