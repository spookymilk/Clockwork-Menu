...
{path=nil,filename=nil,name="Faster Jetpack",execOn=function()editCIP("CharacterPlatformingComponent","fly_speed_max_up",950);end,execOff=function()editCIP("CharacterPlatformingComponent","fly_speed_max_up",100);end,key=nil,toggled=false,isxmlbased=false,cantoggle=true;},
...
{path=nil,filename=nil,name="Infinite Gold",execOn=function()editCIP("WalletComponent","money",math.huge);end,execOff=function()editCIP("WalletComponent","money",10);end,key=nil,toggled=false,isxmlbased=false,cantoggle=true;},
