...
{path=nil,isweapon=true,scripted=true,script=function()createGun("Crazy","","1","151","540","1","15","10","0","5","0","1",{"BOUNCY_ORB","DISC_BULLET","BUBBLESHOT_TRIGGER","BOUNCY_ORB","BURST_4","ARC_ELECTRIC"},{"CRITICAL_HIT","LIGHT_SHOT","CRITICAL_HIT","CRITICAL_HIT","CRITICAL_HIT"},"2","0","15","13","9");end,filename=nil,name="Critical Killer"},
{path=nil,isweapon=true,scripted=true,script=function()createGun("Flute","","1","8","8","1","5","10","0","5","0","1",{"OCARINA_A","OCARINA_B","OCARINA_C","OCARINA_D","OCARINA_E","OCARINA_F","OCARINA_GSHARP","OCARINA_A2"},{},"1","0","5","8","5");end,filename=nil,name="Flute"},
{path=nil,isweapon=true,scripted=true,script=function()createGun("TDF","","1","900","8","1","-255","10","0","0","0","1",{"OCARINA_A","OCARINA_B","OCARINA_C","OCARINA_D","OCARINA_E","OCARINA_F","OCARINA_GSHARP","OCARINA_A2"},{},"1","0","-255","8","-255");end,filename=nil,name="The Devil's Flute"},
