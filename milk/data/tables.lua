...
TABLE_ALL_ANIMALS={"<-- Go Back","Acidshooter","Alchemist","Ant","Assassin","Barfer","Bat","Bigbat","Bigfirebug",
...
TABLE_ALLMATERIALS={};
TABLE_MONSTERS_FRIENDLY=tableClone(TABLE_ALL_ANIMALS);
TABLE_MONSTERS_ENEMY=tableClone(TABLE_ALL_ANIMALS); -- there has to be a better way..
TABLE_MONSTERS_DONTSPAWN=tableClone(TABLE_ALL_ANIMALS);
TABLE_MONSTERS_DONTSPAWNTWO=tableClone(TABLE_ALL_ANIMALS);
