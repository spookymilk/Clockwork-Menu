...
{path=nil,filename=nil,name="Infinite Gold",execOn=function()editCIP("WalletComponent","money",2147483647);end,execOff=function()editCIP("WalletComponent","money",10);end,key=nil,toggled=false,isxmlbased=false,cantoggle=true;}, -- thanks remmie, this should fix the negative problem
